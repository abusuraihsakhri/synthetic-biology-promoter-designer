...
import pytest
from synbio_promoter.models import FrontierPayload, ExecutionStatus
from synbio_promoter.engine import FrontierDomainEngine
from synbio_promoter.agents import PWMSequenceScannerAgent, ThermodynamicTranscriptionAgent, LogicGateOutputVerifierAgent, SynBioPromoterCoordinator
from synbio_promoter.cli import main


def test_sub_agents():
    a1 = PWMSequenceScannerAgent()
    ...
    a2 = ThermodynamicTranscriptionAgent()
    ...
    a3 = LogicGateOutputVerifierAgent()
...
def test_coordinator():
    coord = SynBioPromoterCoordinator()
    ...
    assert "Synthetic Biology Open Language (SBOL 3.0)" in ans or "specifications" in ans

"""
Automated Pytest for synthetic-biology-promoter-designer Enrichment Modules.
"""
import sys
...
from enrichment import (
    QsarModelTrainingPipelineEngine,
...
def test_enrichment_suite_execution():
    suite = SyntheticbiologypromoterdesignerEnrichmentSuite()

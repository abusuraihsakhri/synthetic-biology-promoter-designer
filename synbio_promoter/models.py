"""
Data Models & Telemetry Definitions for SynBio-Promoter: Thermodynamic Transcription Factor Binding & Circuit Agent.
...
class AgentTelemetryAlert:
    ...
    standard_reference: str = "Synthetic Biology Open Language (SBOL 3.0)"
    timestamp: str = field(default_factory=lambda: datetime.datetime.now(datetime.timezone.utc).isoformat())
